...
export class Issue extends Model {
  ...
  declare stato: StatoIssue;
  declare priorita: string | null;
  declare dataInizio: Date | null;
  declare dataScadenza: Date | null;
  declare progettoId: number;
  declare segnalatoreId: number;
  declare assegnatarioId: number | null;
...
Issue.init(
  {
    ...
    tipo: {
      type: DataTypes.ENUM('bug', 'question', 'documentation', 'feature'),
      allowNull: false,
    },
